...
Utiliser ce skill à chaque fin de session de travail sur le projet **Fabula**, avant de fermer l'IDE ou de changer de contexte. Ce skill permet de capitaliser sur le travail effectué et de préparer la session suivante.
